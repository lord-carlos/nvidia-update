...
(Get-Content "$extractFolder\setup.cfg") | Where-Object {$_ -notmatch 'EulaHtmlFile|FunctionalConsentFile|PrivacyPolicyFile'} | Set-Content "$extractFolder\setup.cfg" -Force
